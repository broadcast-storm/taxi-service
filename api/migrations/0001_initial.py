# Generated by Django 3.1.5 on 2021-01-06 15:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('releaseYear', models.DateField(default=datetime.date.today, verbose_name='Год выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderStatus', models.CharField(choices=[('client_waiting', 'клиент ждет машину'), ('client_canceled', 'клиент отменил заказ'), ('in_progress', 'клиента отвозят'), ('completed', 'заказ выполнен')], default='client_waiting', max_length=30, verbose_name='Статус заказа')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Время оформления')),
                ('scheduledTime', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Назначенное время')),
